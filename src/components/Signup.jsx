...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      setAdress(
        `${dir.value}, ${num.value}, ${dpto.value}, ${city.value}, ${state.value}, ${cpa.value}`
      );
      alert("pendiente funcionalidad" + adress);
      navigate("/");
    }
    setValidated(true);
  };
    ...
    <Form noValidate validated={validated} onSubmit={handleSubmit}>
      ...
      <Row className="mb-3">
        <Form.Group as={Col} md="6" controlId="formBasicEmail">
          ...
          <Form.Control.Feedback type="invalid">
            Por favor introduce mail de tipo ejemplo@ejemplo.com
          </Form.Control.Feedback>
        </Form.Group>
      ...
      <Row className="mb-3">
        <Form.Group as={Col} md="8" controlId="validationCustom04">
          ...
          <Form.Control type="text" placeholder="Direccion" required {...dir} />
          <Form.Control.Feedback type="invalid">
